...
<head>
  ...
  <title>Registrasi New Member Rana9</title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Rana9</h2>
              <p>Register Form For New Member of Rana9 </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
              ...
              <div class="reply-form">
                ...
                <h4>Edit Your Member</h4>
                <form action="{{ url('/rana9/'.$data->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <input name="semester" type="text" class="form-control" value="{{ $data->semester }}">
                    </div>
                    <div class="col-md-6 form-group">
                      <label for="prodi">Prodi</label>
                      <input name="prodi" type="text" class="form-control" value="{{ $data->prodi }}">
                    </div>
                    <div class="col form-group">
                      <label for="ormawa">Ormawa</label>
                      <input name="ormawa" type="text" class="form-control" value="{{ $data->ormawa }}">
                    </div>
                  </div>
