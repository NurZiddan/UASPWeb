        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
              ...
              <div class="reply-form">
                ...
                <form action="{{ url('/rana9') }}" method="POST">
                  @csrf
                  <div class="row">
                  ...
                  <table class="table table-stried mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $member->ormawa }}</td>
                        <td>
                          <a href="rana9/{{$member->id}}/edit"><button type="button" class="btn btn-info">Edit</button></a>
                        </td>
                        <td>
                          <form action="{{ url('/rana9/'.$member->id) }}" method="POST">
                          @csrf
                          @method('DELETE')
